                    ...
                    <div className="mb-10 relative border-2 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                        ...
                        <div className="flex items-start justify-between mb-8">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    {guildData.prefix && (
                                        <span className="text-lg font-jersey text-black/40 mt-1 inline-block">[{guildData.prefix}]</span>
                                    )}
                                </div>
                            ...
                            <div className={`px-6 py-3 border-2 border-black ${rankConfig.bg} shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`}>
                                <p className="text-[10px] font-black text-white/60 uppercase tracking-widest">Rank</p>
                                <div className="flex items-center gap-2">
                                    <p className="text-lg font-jersey text-white uppercase tracking-wider">{rankConfig.label}</p>
                                    {playerData.guild?.rankStars && (
                                        <span className="text-white text-xs tracking-tighter drop-shadow-sm">{playerData.guild.rankStars}</span>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-4 gap-4 mb-8">
                            <div className="border-2 border-black p-5 bg-white">
                                ...
                                <p className="text-xs font-black text-black/40 uppercase tracking-widest mb-1">Members</p>
                                <p className="text-3xl font-jersey text-black leading-none">{memberCount}</p>
                            </div>
                            <div className="border-2 border-black p-5 bg-white">
                                <TrendingUp className="w-6 h-6 text-emerald-500 mb-3" />
                                <p className="text-xs font-black text-black/40 uppercase tracking-widest mb-1">Level</p>
                                <p className="text-3xl font-jersey text-black leading-none">{guildData.level || '??'}</p>
                            </div>
                            <div className="border-2 border-black p-5 bg-white">
                                <Swords className="w-6 h-6 text-red-500 mb-3" />
                                <p className="text-xs font-black text-black/40 uppercase tracking-widest mb-1">Wars</p>
                                <p className="text-3xl font-jersey text-black leading-none">{guildData.wars || '??'}</p>
                            </div>
                            <div className="border-2 border-black p-5 bg-white">
                                <MapPin className="w-6 h-6 text-amber-500 mb-3" />
                                <p className="text-xs font-black text-black/40 uppercase tracking-widest mb-1">Territories</p>
                                <p className="text-3xl font-jersey text-black leading-none">{guildData.territories || '??'}</p>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                                ...
                                {Object.entries(playerData.ranking || {}).map(([key, value]: [string, any]) => {
                                    ...
                                    return (
                                        ...
                                        <div key={key} className="flex items-center justify-between border-b border-black/10 pb-4 last:border-b-0 last:pb-0">
                                            ...
                                            <span className="font-jersey text-xl text-amber-500">#{value}</span>
                    ...
                    <div className="col-span-8 space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <StatCard icon={<Sword className="text-red-500" />} label="Mobs Killed" value={playerData.globalData?.mobsKilled?.toLocaleString('tr-TR')} />
                            <StatCard icon={<ScrollText className="text-blue-500" />} label="Completed Quests" value={playerData.globalData?.completedQuests} />
                            <StatCard icon={<Box className="text-amber-500" />} label="Chests Found" value={playerData.globalData?.chestsFound?.toLocaleString('tr-TR')} />
                            <StatCard icon={<Compass className="text-emerald-500" />} label="Content Completion" value={playerData.globalData?.contentCompletion} />
                            <StatCard icon={<MapIcon className="text-indigo-500" />} label="Caves Discovered" value={playerData.globalData?.caves} />
                            <StatCard icon={<Zap className="text-orange-500" />} label="World Events" value={playerData.globalData?.worldEvents} />
                            <StatCard icon={<Shield className="text-rose-500" />} label="Wars" value={playerData.globalData?.wars} />
                            <StatCard icon={<Trophy className="text-purple-500" />} label="Lootruns" value={playerData.globalData?.lootruns} />
                            ...
                            {highestChar && (
                                ...
                                <div className="my-4 bg-linear-to-br from-amber-50 to-orange-50 p-5 border border-black flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 font-medium mt-0.5">{highestChar[1].xp?.toLocaleString('tr-TR')} XP</p>
                                            ...
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="font-bold text-slate-800 text-sm uppercase tracking-wider">{type}</p>

                                                        <p className="text-xs text-slate-400">{stats.count} characters</p>
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-2xl font-jersey text-slate-800 leading-none">Lv.{stats.maxLevel}</p>
                                                ...
                                                <div className="p-6">
                                                    ...
                                                    <div className="flex items-start justify-between mb-5">
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                {charData.reskin && (
                                                                    <span className="text-xs font-bold text-black/40 uppercase tracking-wider">{charData.reskin}</span>
                                                                )}
                                                    ...
                                                    <div className="mb-5">
                                                        ...
                                                        <div className="flex items-end justify-between mb-2">
                                                            ...
                                                            <div className="flex items-baseline gap-2">
                                                                ...
                                                                <span className="text-5xl font-jersey text-black leading-none">Lv.{charData.level}</span>

                                                                <span className="text-sm font-bold text-black/40">/ 106</span>
                                                    ...
                                                    <div className="flex items-center gap-3 mb-4">
                                                        ...
                                                        <div className={`flex-1 border-2 border-black p-3 text-center`}>
                                                            ...
                                                            <p className="text-[9px] font-black text-black/40 uppercase tracking-widest mb-0.5">Total Lv.</p>

                                                            <p className="text-xl font-jersey text-black leading-none">{charData.totalLevel}</p>
                                                        ...
                                                        {charData.wars !== undefined && (
                                                            ...
                                                            <div className={`flex-1 border-2 border-black p-3 text-center`}>
                                                                ...
                                                                <p className="text-[9px] font-black text-black/40 uppercase tracking-widest mb-0.5">Wars</p>

                                                                <p className="text-xl font-jersey text-black leading-none">{charData.wars}</p>
                                                        ...
                                                        {charData.mobsKilled !== undefined && (
                                                            ...
                                                            <div className={`flex-1 border-2 border-black p-3 text-center`}>
                                                                ...
                                                                <p className="text-[9px] font-black text-black/40 uppercase tracking-widest mb-0.5">Kills</p>

                                                                <p className="text-xl font-jersey text-black leading-none">{charData.mobsKilled?.toLocaleString('tr-TR')}</p>
